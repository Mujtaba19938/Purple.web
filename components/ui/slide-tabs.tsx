...
export const SlideTabs = () => {
  ...
  return (
    <ul
      ...
      className="relative mx-auto flex w-fit rounded-full border-2 border-black/20 bg-black/10 backdrop-blur-md p-1 dark:border-white/20 dark:bg-white/10"
    >
...
const Cursor = ({ position }: CursorProps) => {
  return (
    <motion.li
      ...
      className="absolute z-0 h-7 rounded-full bg-black md:h-12 dark:bg-white"
    />
  );
};
